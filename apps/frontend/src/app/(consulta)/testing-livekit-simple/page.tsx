    ...
    <div style={{
      ...
      <div style={{
        ...
        <div style={{
          ...
          <p style={{ margin: '0.25rem 0' }}>• Tipo: Sessão de Teste Simples</p>
          <p style={{ margin: '0.25rem 0' }}>• Pacientes: {testPatients.length} disponíveis</p>
          <p style={{ margin: '0.25rem 0' }}>• Fonte: Pacientes de Teste</p>
        </div>
        ...
        <div style={{
          ...
          <p style={{ margin: '0.25rem 0' }}>• Versão: Simplificada (sem Supabase)</p>
        </div>
      </div>
    </div>
  );
