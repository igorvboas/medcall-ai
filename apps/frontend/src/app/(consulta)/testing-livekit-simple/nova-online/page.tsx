...
function NovaOnlineTestPageContent() {
  ...
  useEffect(() => {
    ...
    console.log('🔍 TESTE LIVEKIT SIMPLES - Parâmetros recebidos:', params);
    setDebugInfo(params);
  ...
  const handleEndCall = () => {
    ...
    router.push('/testing-livekit-simple');
  };
    ...
    return (
      <div style={{
        ...
        <div style={{
          ...
          <button
            onClick={() => router.push('/testing-livekit-simple')}
            style={{
              marginTop: '1rem',
